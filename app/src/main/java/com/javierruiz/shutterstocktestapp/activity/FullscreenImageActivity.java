...
/**
 * Full screen activity with auto hide feature
 */
public class FullscreenImageActivity extends AppCompatActivity {

    public final static String KEY_COMMON_TRANSITION_VIEW = "image";
    public final static String KEY_PARAMETER_IMAGE_FILE = "imageFile";
